...
an advanced exstention to search and fetch for servers and detailed region info with one button
...
2. after downloading find the file of the exstention and extract (move) it to anywhere on your device, but remember the path
3. open chrome and go to exstentions management
4. (if not) enable developer mode
...
<sub>⟪ this extension only exists on github, there are no other publishers than the user "whitte5219" from github, | all safety rights reserved - confirmed safe software ⟫</sub>
